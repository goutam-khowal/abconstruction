...
import React, { useState, useTransition } from "react";
import Image from "next/image";
// 🚀 CLEAN REACT-ICONS IMPORT (No SVG trash, No CDN configs)
          ...
          <div className="lg:col-span-5 space-y-10">
            ...
            <div className="space-y-6 text-sm font-medium text-slate-600">
              ...
              <div className="border-l-2 border-brand-blue pl-4">
                ...
                <a href="tel:9958824813" className="block hover:text-brand-blue transition-colors">
                  📞9958824813
                </a>
              </div>
              <div className="border-l-2 border-brand-blue pl-4">
                ...
                <a href="mailto:contact@abconstructions.co.in" className="block hover:text-brand-blue transition-colors">
                  ✉️contact@abconstructions.co.in
                </a>
              </div>
            </div>

            {/* 🚀 REACT-ICONS BOOTSTRAP DESIGN NODES (Only Email and Instagram) */}
            <div className="space-y-3 pt-2">
              <span className="text-[10px] tracking-[0.2em] font-bold text-slate-400 uppercase block">
                Instant Escalation Nodes
              </span>
              <div className="flex items-center gap-4">
                {/* Email Router Link Component */}
                <a
                  href="mailto:contact@abconstructions.co.in"
                  className="w-12 h-12 flex items-center justify-center bg-blue-50 text-brand-blue border border-blue-200 hover:bg-brand-blue hover:text-white transition-all shadow-sm rounded-full"
                  title="Dispatch Direct Mail"
                >
                  <BsEnvelope size={22} />
                </a>

                {/* Instagram Showcase Link Component */}
                <a
                  href="https://www.instagram.com/abconstruction1977" 
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 flex items-center justify-center bg-rose-50 text-rose-600 border border-rose-200 hover:bg-rose-600 hover:text-white transition-all shadow-sm rounded-full"
                  title="Follow on Instagram"
                >
                  <BsInstagram size={20} />
                </a>
